...
def reform(map_path: Path, reformed_path: Path):
    ...
    # change the path to the path of the julia executable
    command = ['/usr/local/bin/julia', '/bio/kihara-web/www/em/emweb-jobscheduler/reform.jl', f'--map_path={map_path}', f'--reformed_path={reformed_path}']
