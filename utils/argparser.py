...
def argparser():
    ...
    parser.add_argument("--op_folder_path", default="output/", type=str, help="Output folder path",required=True)
    ...
    parser.add_argument("--rosetta_path", default="rosetta", type=str, help="Rosetta path(/your/path/to/rosetta_bin_system_version_bundle/main)")
